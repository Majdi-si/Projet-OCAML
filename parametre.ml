...
let () =
  ...
  print_string "Entrez le temps de séparation ("M", "L") | ("H", "L") | ("H", "M") : ";
  let sep_1= read_int () in
  print_string "Entrez le temps de séparation ("H", "H"): ";
  let sep_2 = read_int () in
  print_string "Entrez le temps de séparation pour le reste  : ";
