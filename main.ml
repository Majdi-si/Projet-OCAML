...
let () =
  ...
  let tous_vols = heure_parking_26R @ heure_parking_27L @ heure_parking_26L @ heure_parking_27R in
  let nombre_parkings_differents = Parking.nombre_parkings_differents tous_vols in
  let liste_parking_differents = Parking.liste_parking_differents tous_vols in
